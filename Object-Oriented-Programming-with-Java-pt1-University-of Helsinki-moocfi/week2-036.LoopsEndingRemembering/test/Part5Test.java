...
public class Part5Test {
    ...
    private static int otaLukuLopusta(String inputStr) {
        ...
        assertTrue("Output should contain line the form \"Even numbers: 3\"", matcher.find());
    ...
    private String rivi(String out, String mj) {
        ...
        fail("You should print the count of even numbers"
                + " in the following form \"Even numbers: 3\"\n");
        return "";    
    }
}
