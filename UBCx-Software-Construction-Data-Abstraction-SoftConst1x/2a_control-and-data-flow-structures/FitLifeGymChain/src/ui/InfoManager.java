...
public class InfoManager {
    ...
    private static final String OLYMPIA_COMMAND = "olympia";
    ...
    private void printInstructions(){
        ...
        System.out.println("Enter '"+ OLYMPIA_COMMAND + "' for FitLife " + OLYMPIA_GYM_NAME);
        ...
        if (str.length() > 0) {
            switch (str) {
                ...
                case PALM_LAKE_COMMAND:
                    ...
                    break;
                case OLYMPIA_COMMAND:
                    printGymInfo(chain.lookupGymByName(OLYMPIA_GYM_NAME));
                    break;
