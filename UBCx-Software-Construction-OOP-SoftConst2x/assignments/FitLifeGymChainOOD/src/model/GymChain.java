...
public class GymChain {
    ...
    //REQUIRES: name, fc != null
    //MODIFIES: this, fc
    //EFFECTS: adds new member with name to chain, registers for class fc, and checks in
    public void joinGymIncentive(String name, FitnessClass fc) {
